...
public class Synch01 {
	...
	public Synch01() {
		/*
		 	super(); // 암묵적으로 상위 클래스의 기본 생성자 호출이 된 상태이다.
...
class NumThread01 extends Thread {
	Synch01 main;	// 넘겨주는 주소를 받을 준비를한다.
	...
	public void run() {
		/*
		 	이 스레드에서 배열변수에 데이터를 기억하는 역할을 할 예정이다.
...
class NumThread02 extends Thread {
	...
	@Override
	public void run() {
		//이 스레드는 배열변수의 데이터를 꺼내서 사용하는 역할을 할 예정임
